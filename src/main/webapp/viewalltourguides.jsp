...
<head>
    <meta charset="UTF-8">
    <title>View All Tour Guides</title>
    <style>
...
<body>
    ...
    <!-- Info Section with Total Tour Guides count -->
    <div class="info-section">
        <p>Total Tour Guides: <c:out value="${tourGuideCount}"/></p>
    </div>

    <h3><i class="fas fa-users"></i> <u>View All Tour Guides</u></h3>
