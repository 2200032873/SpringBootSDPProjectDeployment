...
<body>
    <div class="navbar">
        ...
        <div class="nav-buttons">
            <a href="contentcreatorhome">Home</a>
            <a href="contentcreatorlogout">Logout</a>
        </div>
    ...
    <div class="sidebar" id="sidebar">
        <!-- Conditionally display "Content home" link -->
        <c:if test="${contentcreator.status == 'Accepted'}">
            <a href="index1">
                <i class="bx bx-home"></i> Content Home
            </a>
        </c:if>
        <a href="contentcreatorprofile">
            <i class="bx bx-user"></i> Profile
        </a>
        <a href="updatecontentcreator">
            <i class="bx bx-edit"></i> Update Profile
        </a>
        <a href="contentcreatorcontactus">
