...
<head>
    <meta charset="UTF-8">
    <title>View All Content Creators</title>
    <style>
...
<body>
    ...
    <!-- Info Section with Total Content Creators count -->
    <div class="info-section">
        <p>Total Content Creators: <c:out value="${contentcreatorCount}"/></p>
    </div>

    <h3><i class="fas fa-users"></i> <u>View All Content Creators</u></h3>
